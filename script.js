...
/* Hover效果 */
.feature-img:first-child:hover {
    transform: translateY(-25px) scale(1.05);
    box-shadow: 0 20px 55px rgba(0, 0, 0, 0.6);
    z-index: 3;
}

.feature-img:last-child:hover {
...
.feature-img.expanded {
    ...
    box-shadow: 0 20px 60px rgba(0, 255, 136, 0.35) !important;
}
